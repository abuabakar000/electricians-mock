        ...
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-x-6 gap-y-10 lg:gap-8 mb-10 md:mb-16">
          ...
          <div className="col-span-1 lg:col-span-2 flex flex-col">
            ...
            <div className="flex flex-col gap-4 mt-2">
              <Link href="/" className="text-zinc-400 text-[14px] font-light hover:text-amber-500 transition-colors">Home</Link>
              <Link href="/services" className="text-zinc-400 text-[14px] font-light hover:text-amber-500 transition-colors">Services</Link>
              <Link href="/locations" className="text-zinc-400 text-[14px] font-light hover:text-amber-500 transition-colors">Locations</Link>
              <Link href="/contact" className="text-zinc-400 text-[14px] font-light hover:text-amber-500 transition-colors">Contact</Link>
            </div>
          </div>
          ...
          <div className="col-span-2 lg:col-span-4 flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full max-w-[380px]">
              <Link 
                href="/contact" 
                className="flex-1 bg-amber-500 hover:bg-amber-400 text-zinc-950 px-6 py-3 rounded text-[11px] font-bold tracking-[0.1em] uppercase transition-colors text-center flex items-center justify-center whitespace-nowrap"
              >
                Schedule Service
              </Link>
              <Link 
                href="tel:+18005550199" 
                className="flex-1 bg-transparent border border-zinc-700 hover:border-amber-500 hover:text-amber-500 text-white px-6 py-3 rounded text-[11px] font-bold tracking-[0.1em] uppercase transition-colors text-center flex items-center justify-center gap-2 whitespace-nowrap"
              >
        ...
        <div className="py-6 md:py-8 border-t border-zinc-800/60 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 lg:gap-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-white font-medium text-base tracking-wide">(800) 555-0199</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 lg:-ml-12">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-white font-medium text-[15px]">Your City, State & Surrounding Areas</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <a href="#" className="w-9 h-9 rounded-full border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white hover:border-amber-500 transition-colors">
