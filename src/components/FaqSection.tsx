      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
        ...
        <div className="lg:w-[40%] text-left lg:sticky lg:top-32">
          ...
          <h2 className="text-[38px] md:text-5xl font-light text-white leading-[1.1] tracking-tight mb-6">
            Frequently Asked<br />
            <span className="text-amber-500 font-medium">Questions.</span>
          </h2>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className={`w-7 h-7 rounded-full flex items-center justify-center shrink-0 border transition-colors duration-300 ${isOpen ? 'border-amber-500/30 bg-amber-500/10 text-amber-500' : 'border-zinc-700 bg-zinc-800/50 text-zinc-400'}`}>
                      {isOpen ? (
                  ...
                  <div className={`text-amber-500 transition-transform duration-300 shrink-0 ml-4 ${isOpen ? 'rotate-180' : ''}`}>
                  ...
                  <div className="overflow-hidden">
                    <div className="pl-5 lg:pl-6 pb-5 lg:pb-6 pr-5 lg:pr-6 pt-0 flex gap-4">
                      <div className="w-7 shrink-0 flex justify-center">
                        <div className="w-[2px] h-full bg-amber-500 rounded-full" />
                      </div>
