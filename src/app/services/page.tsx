...
export const metadata = {
  title: "Premium Electrical Services | ProElectric",
  description: "Explore our comprehensive range of high-end electrical services, from emergency repairs to full smart home integrations.",
};
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden border-b border-zinc-800/60">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto pt-24 pb-12">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-light text-white tracking-tighter leading-[1.05] mb-8">
            ...
            <span className="font-medium text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-amber-500">Modern Power.</span>
          </h1>
